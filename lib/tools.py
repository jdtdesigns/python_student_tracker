...
# I need a function that shows a main menu and gets their chosen option - List Students, Add a Student, and Exit
def showMainMenu():
    errorMessage = "\n*** You must enter a valid number option ***"
    choice = input("""
        Please type an option from the below list (Enter the option number):
        1. List Students
        2. Add a Student
        3. Exit
